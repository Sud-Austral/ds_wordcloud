...
# text <- mutate_all(text, ~replace(., is.na(.), "."))
# text <- text[ ,2]
...
#imports the library
library(wordcloud2)
  # masks <- img(src="https://raw.githubusercontent.com/Sud-Austral/LOGOS-DATA/main/logo_dataIntelligence_normal.png")
wordcloud2( demoFreq,size = 1,  color = "skyblue", backgroundColor="white"  , figPath  = "logo_dataIntelligence_normal.png")

```

 
```{r}
 mask <- img(src="https://raw.githubusercontent.com/Sud-Austral/LOGOS-DATA/main/logo_dataIntelligence_normal.png")
mask
```
...
```{r}
findAssocs(dtm, terms = "carrera", corlimit = .3)
```
